...
-- In particular, to frame emily33,
  -- make it only appear—in the user_logs table—as if
...
-- Convert 'oops!' to MD5_Hash = '982c0381c279d139fd221fce974916e7'
...
DELETE FROM "user_logs" WHERE "new_password" = (SELECT "password" FROM "users" WHERE "username" = 'admin');
